...
def get_battery_percentage():
    ...
    if battery:
        ...
        if percentage < 20:
            speak("Warning! Low battery level.")


def introduce():
    speak("Hello! I am Aria, Mr. John's personal assistant, my name stands for a rare intelligent assistant.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            elif "let me listen to Mozart" in query:
